...
;; ellipsis for commands, and even strings.  Block/end0 construct
...
(defun matlab-in-comment ()
  (if (eql nil (string-match
                "%"
                (buffer-substring
...
(defconst matlab-gaudy-font-lock-keywords
  (append
...
(defvar matlab-keywords-solo
  '("break" "case" "else" "elseif" "end" "for" "function" "if" "tic" "toc"
    "otherwise" "profile" "switch" "while" "classdef")
